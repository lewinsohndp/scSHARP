...
if os.path.exists("pbmc_test_trained_model_8_markers_only"):
    ...
    sharp.save_model("pbmc_test_trained_model_8_markers_only")
...
int_df.to_csv("pbmc_test_interpretation_markers_only_test.csv")
